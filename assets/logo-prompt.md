...
## Pattern 2: Japanese Modern (Wa-modern)
...
| **Background** | Solid off-white |
| **Style** | Vector, flat design, Japanese minimalism |

### Color References

| Color | Hex | Japanese Name |
|-------|-----|---------------|
| **Indigo Blue** | `#2B4B7E` | 瑠璃色（るりいろ） |
| **Gold** | `#D4AF37` | 金色（きんいろ） |
| **Off-White** | `#F7F4ED` | 胡粉色（ごふんいろ） |

---

## Release Versions (with version number)
...
| Element | Description |
|---------|-------------|
| **Position** | Harmoniously below the main logo |
| **Size** | Smaller than the main brand text |
| **Weight** | Light/complementary font |
| **Format** | "v0.0.0" (variable for releases) |
